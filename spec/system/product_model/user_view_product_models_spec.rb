...
describe 'Usuario acessa modelos de produtos' do
  ...
  it 'e vê modelos de produtos' do
    ...
    product_model = ProductModel.create!(name: 'Monitor 8k', wight: 2000, width: 90, height: 30, depth: 2, sku: 'MT8000-KOREJVNERTYUIO', supplier: supplier)

    visit root_path
    click_on 'Modelos de produtos'

    expect(page).to have_content 'Monitor 8k'
    expect(page).to have_content 'MT8000-KOREJVNERTYUIO'
